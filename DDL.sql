###Part 3: DDL for relational Schema
...
create table membersFromCommittee(
	...
	last_name varchar(50) not null,
	committee_name varchar(20) not null,
	foreign key(member_id, first_name, last_name) references Committee_Members (member_id, first_name, last_name) on delete cascade,
	foreign key(committee_name) references Sub_Committee (committee_name) on delete cascade
	);
